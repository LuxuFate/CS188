...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        for ghost in livingGhostPositionDistributions:
            ...
            if self.distancer.getDistance(pacmanPosition, ghostPos) < ghostDist:
        ...
        for act in legal:
            ...
            if self.distancer.getDistance(successorPosition, ghostClose) < closest:
                closest = self.distancer.getDistance(successorPosition, ghostClose)
                bestAction = act
        return bestAction
        "*** END YOUR CODE HERE ***"
